      ...
      <AppBar position="relative" color="primary">
        <Toolbar>
          ...
          {isAuthenticated && (<Stack sx={{ display: "flex", flexDirection: "row"}} columnGap={3}>
            <Button variant="contained" color="secondary" sx={{marginLeft: 2}} onClick={navigateToProfile}>Profile</Button>

            <Button variant="contained" color="secondary" sx={{marginLeft: 2}} onClick={handleLogout}>Log out</Button>
            </Stack>)}
